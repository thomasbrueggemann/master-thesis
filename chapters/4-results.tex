...
The full review results of the human researchers can be found in Appendix B.
...
Another first attempt was to detect if any background services are being started by the app in question.
