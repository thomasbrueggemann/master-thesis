...
If none of the search words are found within the identifiers of text input fields the probability property of the result object is set to \textit{MEDIUM}.
...
The just explained propability property value '\textit{MEDIUM}' for non-found input information collection dataflows holds true for the rest of the following strategies that use the InputInformationCollectionStrategy.
% CI322
