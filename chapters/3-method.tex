...
\lstinputlisting[language=Java, label=listing:TraceBackStrategy, caption=Generic strategy TraceBackStrategy.java to find the existance of search words within source code]{TraceBackStrategy.java}
