...
\textit{ExistanceStrategy}.
The generic ExistanceStratagy ist the most widely used strategy within the analysis tool.
Strategy \textit{CH23} uses the ExistanceStrategy twice to check if data transfers are secure. 
