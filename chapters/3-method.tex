...
\lstinputlisting[language=Java, label=listing:DataFlowStrategy, caption=Generic strategy DataFlowStrategy.java to find the existance of search words within source code]{DataFlowStrategy.java}
% DataFlowStrategy
...
\lstinputlisting[language=Java, label=listing:ExistanceStrategy, caption=Generic strategy ExistanceStrategy.java to find the existance of search words within source code]{ExistanceStrategy.java} 
...
\lstinputlisting[language=Java, label=listing:InputStrategy, caption=Generic strategy InputStrategy.java to find the existance of search words within source code]{InputStrategy.java}
...
\newpage
\lstinputlisting[language=Java, label=listing:TraceBackStrategy, caption=Excerpt of the generic strategy TraceBackStrategy.java to trace defined information sources to information sinks via dataflow analysis]{TraceBackStrategy.java}
...
\lstinputlisting[language=Java, label=listing:InputInformationCollectionStrategy, caption=Generic strategy InputInformationCollectionStrategy.java to find the existance of search words within source code]{InputInformationCollectionStrategy.java}
...
\lstinputlisting[language=Java, label=listing:PermissionStrategy, caption=Generic strategy PermissionStrategy.java to find the existance of search words within source code]{PermissionsStrategy.java}
