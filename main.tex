...
\PassOptionsToPackage{hyphens}{url}\usepackage[
	pdftitle={Master Thesis: Automated Information Privacy Risk Assessment of Android Health Applications}, % Document-Title
	pdfsubject={Master Thesis, Thomas Brüggemann, 2016}, % Subject
	pdfauthor={Thomas Brüggemann}, % Author(s)
	pdfkeywords={Master, Thesis, Master Thesis, M.Sc., M. Sc., Information Systems, IS, Wirtschaftsinformatik, University, Universität, Köln, Universität zu Köln, University of Cologne, Android, mHealth, Code, Analysis, Privacy, Risks}, % Keywords
	colorlinks=false,
	breaklinks=true
]{hyperref}
...
\titlecontents{figure}      % set formatting for \figure 
[2.3em]                     % adjust left margin
{\vspace{0.5em}}            % font formatting
{\contentslabel{2.3em}}     % section label and offset
{\hspace*{-2.3em}}
...
\titlecontents{table}       % set formatting for \table 
[2.3em]                     % adjust left margin
{\vspace{0.5em}}            % font formatting
{\contentslabel{2.3em}}     % section label and offset
{\hspace*{-2.3em}}
...
\titlecontents{lstlisting}  % set formatting for \lstlisting 
[2.3em]                     % adjust left margin
{\vspace{0.5em}}            % font formatting
{\contentslabel{2.3em}}     % section label and offset
{\hspace*{-2.3em}}
...
\titlecontents{longtable}       % set formatting for \longtable 
...
\newcommand{\dca}{dynamic code analysis }
\newcommand{\Sca}{Static code analysis }
