...
\begin{longtable}{>{\bfseries}p{2cm} p{10.1cm}}
    \arrayrulecolor{lightgray}
    1 Introduction & Die Einleitung gibt einen Überblick über die Problemstellung, Zielsetzung, Vorgehensweise und den Aufbau der Arbeit \\\hline
    
    1.1 Problem Statement & Beschreibung des Forschungskreislaufes der Bachelorarbeit um das Praxisproblem und dessen Relevanz sowie das Forschungsproblem und dessen Relevanz zu erörtern (1 Seite)\\\hline
    
    1.2 Objectives & Beschreibung des Hauptziels und der damit verbundenen Subziele um den Roten Faden der Bachelorarbeit zu verdeutlichen (\nicefrac{1}{2} Seite)\\\hline
    
    1.3 Method & Eine kurze Erläuterung der Vorgehensweise des systematischen Literaturreviews, der den Hauptteil der Arbeit ausmacht (1 Seite)\\\hline
    
    1.4 Structure & Formaler Aufbau und Übersicht der Arbeit wird beschrieben (\nicefrac{1}{2} Seite)\\\hline\hline
    
    2 Automated Privacy Risk Assessment & Dieses Kapitel beschreibt die grundlegenden Begriffe zum Thema Cloud Computing.\\\hline
    
    2.1 Privacy Risk Factors & Ausformulierung der Definition, was Cloud Computing auszeichnet (2 Seiten)\\\hline
    
    2.2 Implementation & Cloud Computing unterteilt sich in drei Servicemodelle, diese werden hier erörtert (2 Seiten)\\\hline
    
    2.2.1 Download Phase & test \\\hline
    
    2.2.2 Decompilation Phase & test \\\hline
    
    2.2.3 Static Code Analysis Phase & test \\\hline
    
    2.3 Results & Beschreibung der verschiedenen Möglichkeiten Cloud Computing einzusetzen. (1 Seite)\\\hline\hline
    
    3 Evaluation & Wie wurden die Herausforderungen des Cloud Computing in Literatur und Konferenzbeiträgen adressiert?\\\hline
    
    3.1 Evaluation of Implementation & Zusammentragen und Erörtern der, in der Literatur und in Konferenzbeiträgen, adressierten Herausforderungen (4 Seiten)\\\hline
    
    3.2 Overview of Users' Opinions & Eine quantitative Analyse der gefundenen Herausforderungen, also die eigentliche Auswertung der Excel-Tabelle (5 Seiten)\\\hline\hline

    4 Conclusion & Abschließende kritische Reflexion der erarbeiteten Ergebnisse, Beurteilung der Zielerreichung und kritische  Würdigung der Arbeit (1-2 Seiten)
    
    4.1 Limitations & Test \\\hline
    
    4.2 Future Research & test \\\hline
\end{longtable}
