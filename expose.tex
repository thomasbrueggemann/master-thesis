...
\begin{longtable}{>{\bfseries}p{5.2cm} p{9.1cm}}
    ...
    2.2.1 Download Phase & Description of the \acs{APK} file discovery and download phase of the tool. Free Android apps are available for everybody with an Android smartphone. We want to feed \mH apps into our automated system and therefore need to download the \acs{APK} files automatically.\\\hline
