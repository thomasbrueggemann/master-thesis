...
The evaluation phase starts with an overview of the degree of privacy risk assessment automation has been detected, we are going to switch over to the evaluation phase of the study.
...
It can be used alongside with downloading apps from the Google PlayStore.

In order to evaluate the automated privacy risk assessment, we will expose 15 potential users of the 
